...
case $DD_SERVICE in
    "vulcan")
        keytool -import -noprompt -alias user-manager-cert -keystore $JAVA_HOME/jre/lib/security/cacerts -file /vulcan/services/user-manager/certificate/cert.pem -storepass changeit
        keytool -import -noprompt -alias god-manager-cert -keystore $JAVA_HOME/jre/lib/security/cacerts -file /vulcan/services/god-manager/certificate/cert.pem -storepass changeit
        keytool -import -noprompt -alias authenticator-cert -keystore $JAVA_HOME/jre/lib/security/cacerts -file /vulcan/services/authenticator/certificate/cert.pem -storepass changeit
